...
namespace StudentRegistration.WebAPI.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            var user = new ApplicationUser() { UserName = model.Email, StudentId = model.StudentId, Email = model.Email, First = model.First,Last = model.Last }; //TODO add properties here
